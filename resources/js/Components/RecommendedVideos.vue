...
//import RecommendedVideos from 'vue-material-design-icons/RecommendedVideos.vue'
...
<template>
    ...
    <div class="w-[500px]">
        <div class="px-1.5 pl-3 text-white mt-1">
            <div class="text-[15px] pb-1.5 font-extrabold w-full cursor-pointer">{{ vid.title }}
            </div>
            ...
            <div class="text-[11px] mb-1 text-gray-300 cursor-pointer">{{ vid.views }}</div>
        </div>
    </div>
